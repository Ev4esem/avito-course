...
const faqs = [
  {
    ...
    answer: 'Да. Мы обучаем с полного нуля. Всё объясняется простым языком, без сложных терминов. Вы идёте шаг за шагом и понимаете каждый этап. Справляется каждый, кто просто выполняет задания.',
  },
  {
    question: 'А если я никогда не работал(а) в продажах?',
    answer: 'Отлично. Мы покажем, как писать объявления, которые продают, даже если вы раньше этим не занимались. Всё по готовым шаблонам и примерам.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Один клиент приносит в среднем 20 000–50 000 ₽ в месяц. 3–5 клиентов — и вы уже выходите на стабильный высокий доход.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Мы ведём до результата и даём гарантию. Если вы выполняете задания — у вас обязательно получится. Всё построено так, чтобы довести вас до первого дохода.',
  },
];
