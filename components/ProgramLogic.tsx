...
const steps = [
  {
    num: '1',
    title: 'Осваиваешь нейросети и услугу',
    desc: 'Разбираешься в инструментах и понимаешь, как создавать ценность для клиентов',
  },
  {
    num: '2',
    title: 'Учишься находить и закрывать клиентов',
    desc: 'Получаешь рабочие скрипты продаж и стратегии поиска первых заказчиков',
  },
  {
    num: '3',
    title: 'Создаёшь и прокачиваешь личный бренд',
    desc: 'Выстраиваешь образ эксперта, который притягивает клиентов сам',
  },
  {
    num: '4',
    title: 'Убираешь страх продаж и камеры',
    desc: 'Прокачиваешь речь и психологию влияния — становишься уверенным в любых переговорах',
  },
  {
    num: '5',
    title: 'Осваиваешь монтаж Reels',
    desc: 'Делаешь вирусный контент, который работает на тебя 24/7 и привлекает новых клиентов',
  },
];
