...
const guarantees = [
  {
    ...
    body: [
      'Если в течение первых 3 дней вы понимаете, что формат, подача или программа вам не подходят — я делаю полный возврат средств без лишних вопросов и разбирательств.',
      'Без скрытых условий. Без давления. Без «попробуйте ещё».',
      'Вы принимаете решение — я возвращаю деньги.',
    ],
  },
  {
    num: '2',
    ...
    body: [
      'Моя задача — не просто дать информацию, а довести вас до результата.',
      'Если вы выполняете все рекомендации, внедряете стратегии и следуете системе, но не выходите на результат и не окупаете обучение — я делаю полный возврат средств.',
      'Мне важно ваше реальное достижение, а не просто факт прохождения программы.',
    ],
  },
];
            ...
            <div className="relative h-full min-h-[360px] rounded-3xl overflow-hidden bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] border border-white/10 flex items-center justify-center">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-[#0A0A0A]/90 backdrop-blur-sm border border-[#D4AF37]/30 w-full">
                  ...
                  <div>
                    <div className="font-display font-black text-white text-sm">Вы ничем не рискуете</div>
